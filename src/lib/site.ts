export const siteConfig = {
  ...
  reviewsSection: {
    ...
    quotes: [
      "Nhà mình có em bé nên rất quan tâm vấn đề sạch sẽ. Sau khi dùng HomeCare365 mình thấy yên tâm hơn rất nhiều.",
      "Nhân viên làm việc cẩn thận, thân thiện và rất chuyên nghiệp. Nhà sạch thơm như mới.",
      "Đi làm về chỉ muốn nghỉ ngơi, giờ đã có HomeCare365 lo hết việc nhà giúp mình.",
      "Mình thuê tổng vệ sinh cuối tuần, cả gia đình ai cũng thích vì nhà cửa sạch và gọn hơn hẳn.",
      "Dịch vụ đúng giờ, hỗ trợ nhanh và làm rất có tâm. Sẽ tiếp tục sử dụng lâu dài.",
      "Từ ngày thuê dọn dẹp định kỳ, mình có thêm thời gian chăm sóc bản thân và gia đình.",
      "Nhân viên rất lịch sự và kỹ tính. Những góc nhỏ trong nhà cũng được làm sạch cẩn thận.",
      "Mình cực kỳ hài lòng vì nhà sạch nhưng đồ đạc vẫn được sắp xếp ngăn nắp như cũ.",
      "Gia đình có người lớn tuổi nên rất cần không gian sạch sẽ. HomeCare365 làm mình rất yên tâm.",
      "Dịch vụ chuyên nghiệp hơn mình nghĩ rất nhiều. Đặt lịch nhanh và hỗ trợ tận tình.",
      "Sau khi dọn xong cảm giác căn nhà sáng và thoáng hơn hẳn. Rất đáng trải nghiệm.",
      "Mình bận kinh doanh nên gần như không có thời gian lau dọn. HomeCare365 giúp mình tiết kiệm rất nhiều thời gian.",
      "Nhân viên đến đúng giờ, đồng phục gọn gàng và làm việc rất chuyên nghiệp.",
      "Cảm giác bước vào một căn nhà sạch sẽ sau ngày dài làm việc thật sự rất thư giãn.",
      "Mình thích nhất là sự chỉn chu và thái độ phục vụ nhiệt tình của đội ngũ nhân viên.",
      "Nhà có trẻ nhỏ nên mình khá kỹ tính, nhưng HomeCare365 làm sạch rất cẩn thận và an toàn.",
      "Dịch vụ phù hợp với những người bận rộn như mình. Không cần lo việc nhà nữa.",
      "Không chỉ sạch mà còn rất thơm và gọn gàng. Cảm giác như được làm mới cả căn nhà.",
      "Đội ngũ hỗ trợ nhanh, tư vấn rõ ràng và luôn đúng hẹn mỗi lần đặt lịch.",
      "Mình đã thử nhiều nơi nhưng HomeCare365 cho cảm giác chuyên nghiệp và tận tâm nhất.",
    ],
  },
  finalCta: {
